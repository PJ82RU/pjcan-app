export default {
	...
	BtnsSetting_Title: 'Настройки',
	BtnsSetting_MenuMode: 'Кнопка MODE',
	BtnsSetting_MenuSeekUp: 'Кнопка SEEK UP',
	BtnsSetting_MenuSeekDown: 'Кнопка SEEK DOWN',
	BtnsSetting_MenuVolUp: 'Кнопка VOL UP',
	BtnsSetting_MenuVolDown: 'Кнопка VOL DOWN',
	BtnsSetting_MenuVolMute: 'Кнопка VOL MUTE',

	BtnsSetting_Resistance: 'Сопротивление кнопки',
	BtnsSetting_Resistance_Comment: 'Сопротивление кнопки в условных единицах',
	BtnsSetting_PressSingle: 'Кнопка нажата 1 раз',
	BtnsSetting_PressSingle_Comment: 'Функция, которая выполняется при нажатии кнопки',
	BtnsSetting_PressDual: 'Кнопка нажата 2 раза',
	BtnsSetting_PressDual_Comment: 'Функция, которая выполняется при нажатии кнопки 2 раза',
	BtnsSetting_PressTriple: 'Кнопка нажата 3 раза',
	BtnsSetting_PressTriple_Comment: 'Функция, которая выполняется при нажатии кнопки 3 раза',
	BtnsSetting_PressHold: 'Удержание кнопки',
	BtnsSetting_PressHold_Comment: 'Функция, которая выполняется при нажатии и удержании кнопки 3 более секунд.',
	BtnsSetting_Release: 'Кнопка отпущена',
	BtnsSetting_Release_Comment: 'Функция, которая выполняется если кнопка отпущена',

	BtnsSetting_Func_Teyes_None: 'Кнопка Teyes отпущена',
	BtnsSetting_Func_Teyes_Mode: 'Кнопка Teyes MODE',
	BtnsSetting_Func_Teyes_SeekUp: 'Кнопка Teyes SEEK UP',
	BtnsSetting_Func_Teyes_SeekDown: 'Кнопка Teyes SEEK DOWN',
	BtnsSetting_Func_Teyes_VolUp: 'Кнопка Teyes VOL UP',
	BtnsSetting_Func_Teyes_VolDown: 'Кнопка Teyes VOL DOWN',
	BtnsSetting_Func_Teyes_VolMute: 'Кнопка Teyes VOL MUTE',
	BtnsSetting_Func_LCD_ClockPress: 'Кнопка Clock на LCD нажата',
	BtnsSetting_Func_LCD_ClockRelease: 'Кнопка Clock на LCD отпущена',
	BtnsSetting_Func_LCD_ClockHPress: 'Кнопка Clock H на LCD нажата',
	BtnsSetting_Func_LCD_ClockHRelease: 'Кнопка Clock H на LCD отпущена',
	BtnsSetting_Func_LCD_ClockMPress: 'Кнопка Clock M на LCD нажата',
	BtnsSetting_Func_LCD_ClockMRelease: 'Кнопка Clock M на LCD отпущена',
	BtnsSetting_Func_LCD_InfoPress: 'Кнопка Info на LCD нажата',
	BtnsSetting_Func_LCD_InfoRelease: 'Кнопка Info на LCD отпущена',
	BtnsSetting_Func_Engine: 'Кнопка показать значения ДВС',
	BtnsSetting_Func_Fuel: 'Кнопка показать значения расхода',
	BtnsSetting_Func_Movement: 'Кнопка показать значения движения',
	BtnsSetting_Func_Temperature: 'Кнопка показать значения температуры'
};
