	...
	buttons: {
		...
		functions: {
			...
			v4_1_5: {
				...
				17: "Head Unit: open the camera",
				18: "Head Unit: open the phone",
				19: "Head Unit: play/pause",
				20: "On-board: INFO button (on-board information)",
				21: "On-board: CLOCK button (time on the on-board)",
				22: "On-board: CLOCK H button (hour)",
				23: "On-board: CLOCK M button (minutes)",
				24: "On-board: CLOCK 24/12 button (time format change)",
				25: "On-board: Reset button for minutes to 0",
				26: "On-board: change the INFO mode to CLOCK and back",
				27: "On-board: pressing and holding the INFO button (flow reset)",
				28: "On-board: pressing and holding the CLOCK button (setting the clock)",
				29: "BOSE: on/off the amplifier",
				30: "BOSE: on/off Audio PLT",
				31: "BOSE: MUTE",
				32: "BOSE: VOL +",
				33: "BOSE: VOL -",
				34: "BOSE: BALANCE +",
				...
				40: "BOSE: TREBLE +",
				41: "BOSE: TREBLE -",
				42: "BOSE: switching Center Point modes (cyclically)"
			}
		},
