export default {
	...
	options: {
		...
		datetime: {
			title: "Дата и время",
			description:
				"Для отображения даты и времени на экране БК необходимо каждый раз при включении зажигания запускать web-приложение для синхронизации данных с адаптером PJCAN.",
