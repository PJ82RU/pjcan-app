export default {
	BLE: {
		...
		notify: {
			noConnected: "Нет подключения к устройству Bluetooth.",
			connected: "PJCAN подключен",
			disconnected: "PJCAN отключен",
			lostConnected: "Потеряно подключение с устройством Bluetooth PJCAN. Попытка восстановить связь...",
		...
		server: {
			...
			getService: "GATT-сервер подключен, чтение сервиса...",
			getCharacteristic: "Сервис получен, чтение характеристики...",
	...
	update: {
		...
		notify: {
			...
			completed: "Обновление прошивки успешно завершено",
			warning: "Обновление прошивки завершилось неудачно. Выключите и включите устройство, а затем попробуйте обновить еще раз.",
			error: "Ошибка обновления прошивки",
			errorDownload: "Ошибка загрузки прошивки с сервера. Возможно, отсутствует подключение к интернету.",
			errorUpload: "Ошибка загрузки прошивки на устройство PJCAN. Возможно, отсутствует подключение по Bluetooth.",
			errorWaitUpdate:
				"Истекло время ожидания ответа от устройства PJCAN. Выключите и включите устройство, а затем попробуйте обновить еще раз."
		}
	},
	...
	rules: {
		...
		english: "Допускаются только латинские символы и цифры."
	},
	...
	activation: {
		success: "Устройство успешно активировано! Перезагрузка...",
	...
	deviceReset: {
		...
		config: "Сбросить общую конфигурацию до заводских настроек",
		configShort: "Общую конфигурацию",
		view: "Сбросить настройки отображения до заводских",
		viewShort: "Конфигурацию отображения",
		buttons: "Сбросить настройки кнопок до заводских",
	...
	onboard: {
		...
		viewSetting: {
			...
			type: {
				...
				description: "Отображать статичный, мигающий или текст в виде бегущей строки",
		...
		info: {
			...
			voltmeter: {
				title: "Напряжение",
				description: "Напряжение бортовой сети в вольтах (среднее значение за 10 секунд)",
				menu: "LCD: Напряжение"
			},
			temperatureIn: {
		...
		engine: {
			...
			load: {
				...
				description: "Процент нагрузки на ДВС",
			...
			throttle: {
				title: "Положение дросс. заслонки",
				description: "Относительное положение дроссельной заслонки",
				menu: "LCD: Положение дросс. заслонки"
			},
			coolant: {
			...
			oilLifePercent: {
				title: "Ресурс масла, %",
				titleShort: "Ресурс, %",
				description: "Оставшийся ресурс масла в процентах",
				menu: "LCD: Ресурс масла, %"
			},
			oilLifeDistance: {
				title: "Пробег до замены масла, км",
				titleShort: "Пробег, км",
				description: "Оставшийся пробег до замены масла в километрах",
				menu: "LCD: Пробег до замены, км"
			},
			statistics: {
				title: "Статистика"
			},
			...
			oilSettings: {
				title: "Настройки статистики масла",
				menu: "Статистика масла",
				oilDurationHours: {
					title: "Наработка на масле, ч.",
					titleShort: "Наработка, ч.",
					description: "Общая наработка двигателя на текущем масле"
				},
				oilDistanceKm: {
					title: "Пробег на масле, км",
					titleShort: "Пробег, км",
					description: "Общий пробег автомобиля на текущем масле"
				},
				oilHoursLimit: {
					title: "Лимит замены масла, ч.",
					titleShort: "Лимит масла, ч.",
					description: "Лимит моточасов для замены масла"
				},
				oilHoursLimitItems: [
					"ILSAC / Япония (220 ч) — для Mazda (По умолчанию)",
					"ACEA / Европа (250 ч) — крепкие масла",
					"PAO / Премиум (300 ч) — ПАО-синтетика",
					"Минеральное (180 ч) — простые масла",
					"Свой лимит..."
				],
				oilHoursLimitCustom: {
					title: "Свой лимит, ч.",
					description: "Введите свой лимит замены масла (от 150 до 350 часов)"
				}
			}
		},
		...
		fuel: {
			...
			settings: {
				...
				ratio: {
					...
					description: "Для корректировки расхода ГБО или другого вида топлива"
				}
			}
		},
		...
		doors: {
			...
			settings: {
				...
				frontBackReverse: {
					...
					description: "Поменять местами передние и задние двери"
				}
			}
		},
	...
	buttons: {
		...
		pressHold: {
			...
			description: "Функция, которая выполняется при удержании кнопки 3 и более секунд.",
			time: {
		...
		functions: {
			...
			24: "БК: сброс минут в 0",
			25: "БК: переключить режим INFO/CLOCK",
			26: "БК: удержание INFO (сброс расхода)",
			27: "БК: удержание CLOCK (настройка часов)",
			...
			39: "BOSE: TREBLE +",
			40: "BOSE: TREBLE -",
			41: "BOSE: переключение режимов CenterPoint (циклично)"
		},
		...
		notify: {
			...
			notDefined: "Нажатая кнопка не определена!"
		}
	},
	...
	options: {
		...
		lcd: {
			...
			logo: {
				title: "Логотип",
				description: "Текст, отображаемый при отсутствии данных для вывода на экран БК. Максимум 12 символов."
			},
			hello: {
				title: "Текст приветствия",
				description: "Текст, отображаемый при включении ACC. Максимум 32 символа.",
		...
		head: {
			...
			holdToFlip: {
				...
				description: "Плавное изменение уровня звука при удержании кнопок Vol+/Vol- (рекомендуется, если ГУ не поддерживает эту функцию)."
			}
		},
		datetime: {
			title: "Дата и время",
		...
		onboard: {
			...
			titleShort: "БK",
			description:
				"Список карточек, отображаемых на экране \"Бортовой компьютер\". Порядок меняется перетаскиванием блоков. Также можно включать/выключать отображение на странице.",
			reset: {
	...
	scanner: {
		dialog: {
			...
			text: "Начать сканирование CAN-шины?\n" + "Данные сканирования будут автоматически отправлены PJ82."
		},
		btn: {
			start: "Начать",
			next: "Далее",
		...
		step: {
			...
			1: {
				...
				text:
					...
					"2. Откройте заднюю левую дверь и закройте ее;\n" +
					"3. Откройте багажник и закройте его;\n" +
					"4. Откройте заднюю правую дверь и закройте ее;\n" +
					"5. Откройте переднюю правую дверь и закройте ее.\n" +
					"\n" +
	...
	choosingCarModel: {
		...
		description: "Возможность изменить модель автомобиля, поддерживаемую адаптером PJCAN.",
		carModels: {
			0: "Mazda",
			1: "Mazda 3 BK",
			2: "Mazda 3 BL",
