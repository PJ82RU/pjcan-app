export default {
	...
	options: {
		...
		teyes: {
			...
			sendButton: {
				title: "Кнопки руля",
				description: "Управление ГУ кнопками на руле"
			},
			sendClimate: {
				title: "Показать климат на ГУ",
				description: "Показать значения климат-контроля на ГУ (если протокол поддерживает данный функционал)"
			},
			sendDoors: {
			...
			reverseUart: {
				...
				description: "Включить, если нет связи PJCAN с ГУ"
			}
		},
		onboard: {
			title: "Бортовой компьютер",
