	...
	buttons: {
		...
		functions: {
			...
			v4_1_5: {
				...
				18: "ГУ: открыть телефон",
				19: "ГУ: пауза/играть",
				20: "БК: кнопка INFO (информация БК)",
				21: "БК: кнопка CLOCK (время на БК)",
				22: "БК: кнопка CLOCK H (часы)",
				23: "БК: кнопка CLOCK M (минуты)",
				24: "БК: кнопка CLOCK 24/12 (смена формата времени)",
				25: "БК: кнопка сброса минут в 0",
				26: "БК: сменить режим INFO на CLOCK и обратно",
				27: "БК: нажатие и удержание кнопки INFO (сброс расхода)",
				28: "БК: нажатие и удержание кнопки CLOCK (настройка часов)",
				29: "BOSE: вкл/выкл усилителя",
				30: "BOSE: вкл/выкл Audio PLT",
				31: "BOSE: MUTE",
				32: "BOSE: VOL +",
				33: "BOSE: VOL -",
				34: "BOSE: BALANCE +",
				...
				40: "BOSE: TREBLE +",
				41: "BOSE: TREBLE -",
				42: "BOSE: переключение режимов Center Point (циклично)"
			}
		},
