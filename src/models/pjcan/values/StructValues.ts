...
import { API_VARIABLE_VALUE_SIZE, StructVariablesValue } from "../variables/values";

export const API_VALUE_SIZE = API_DEVICE_VALUE_SIZE + API_LCD_VALUE_SIZE + API_VARIABLE_VALUE_SIZE;
