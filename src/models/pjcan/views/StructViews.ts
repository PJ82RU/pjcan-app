...
import { API_VARIABLE_VIEW_SIZE, StructVariableViews } from "../variables/views";

export const API_VIEW_SIZE = API_CAR_VIEW_SIZE + API_TEYES_VIEW_SIZE + API_VARIABLE_VIEW_SIZE;
