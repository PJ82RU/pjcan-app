...
export default {
	...
	setup()
	{
		...
		canbus.addListener(API_ONBOARD_CONFIG_EVENT, (data: DataView) =>
		{
			store.commit("config/setOnboard", data);
		});
		canbus.addListener(API_HEAD_UNIT_CONFIG_EVENT, (data: DataView) => store.commit("config/setHead", data));
		canbus.addListener(API_SW1_CONFIG_EVENT, (data: DataView) => store.commit("config/setSW1", data));
		...
		// canbus.addListener(API_VOLUME_VALUE_EVENT, (data: DataView) => store.commit("config/setVolume", data));
		...
		canbus.addListener(API_SW1_VALUE_EVENT, (data: DataView) => store.commit("value/setSW1", data));
		...
		canbus.addListener(API_ONBOARD_VIEW_EVENT, (data: DataView) => store.commit("view/setOnboard", data));
		canbus.addListener(API_HEAD_UNIT_VIEW_EVENT, (data: DataView) => store.commit("view/setHeadText", data));
